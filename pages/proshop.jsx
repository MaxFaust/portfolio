      ...
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <button className="px-8 py-2 my-4 mr-8 hover:scale-110 ease-in duration-300">Code</button>
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <button className="px-8 py-2 my-4 mr-8 hover:scale-110 ease-in duration-300">Demo</button>
          </a>
          <div className="flex justify-left py-2">
          <Link href="/#projects">
            <a>
              <button className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300">
